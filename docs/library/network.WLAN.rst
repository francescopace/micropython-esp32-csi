...
.. note::
   ...
   The ``CSI`` board variants of supported generic ESP32 boards enable this in
   their default configuration. Other builds need
   ``CONFIG_ESP_WIFI_CSI_ENABLED=y`` in the ESP-IDF configuration.
